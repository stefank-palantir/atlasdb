...
# Container 1
CONTAINER_1=(':atlasdb-cassandra-integration-tests:check'  ':atlasdb-ete-test-utils:check' ':atlasdb-cassandra:check' ':atlasdb-api:check')

# Container 2
CONTAINER_2=(':atlasdb-ete-tests:check' ':atlasdb-dbkvs-tests:check' ':atlasdb-tests-shared:check')

#Container 3
CONTAINER_3=(':atlasdb-cassandra-more-integration-tests:check', ':atlasdb-timelock-ete:check' ':lock-impl:check')
