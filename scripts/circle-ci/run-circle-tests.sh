...
# Container 1
CONTAINER_1=(':atlasdb-cassandra-integration-tests:check -D:atlasdb-cassandra-integration-tests:test.single=Suite1' ':atlasdb-tests-shared:check' ':atlasdb-timelock-ete')

# Container 2
CONTAINER_2=(':atlasdb-ete-tests:check' ':atlasdb-config')
...
CONTAINER_5=(':atlasdb-dbkvs:check' ':atlasdb-cassandra-multinode-tests:check' ':atlasdb-impl-shared:check' ':atlasdb-dropwizard-bundle:check' ':timestamp-impl')
